...
export const menuItems: MenuItem[] = [
  ...
  // Menu Déjeuner - Entrées
  {
    id: 'le1',
    name: "Œuf Parfait 64°",
    description: "Crème de champignons, chips de pancetta, mouillettes briochées",
    price: 18,
    category: 'starter',
    menuType: 'lunch',
    image: "/images/plats/oeuf.jpg",
    tags: ['vegetarian'],
  ...
  },
  {
    ...
    description: "Agrumes, avocat, vinaigrette passion, herbes fraîches",
    price: 32,
    category: 'starter',
    menuType: 'lunch',
    image: "/images/plats/salade-homard.jpg",
    tags: ['gluten-free'],
    allergens: ['crustacés'],
    isSignature: true,
    isAvailable: true,
  ...
  },
  {
    ...
    description: "Burrata crémeuse, basilic frais, huile d'olive vierge",
    price: 22,
    category: 'starter',
    menuType: 'lunch',
    image: "/images/plats/gaspacho.jpg",
    tags: ['vegetarian', 'gluten-free'],
    allergens: ['lait'],
    isSignature: false,
    isAvailable: true,
  ...
  // Menu Déjeuner - Plats
  {
    ...
    description: "Risotto aux petits pois, jus de crustacés léger",
    price: 38,
    category: 'main',
    menuType: 'lunch',
    image: "/images/plats/bar.jpg",
    tags: ['gluten-free'],
    allergens: ['poisson', 'crustacés', 'lait'],
    isSignature: false,
    isAvailable: true,
    order: 1,
  },
  {
    ...
    description: "Jus au thym, purée de pommes de terre truffée, légumes glacés",
    price: 34,
    category: 'main',
    menuType: 'lunch',
    image: "/images/plats/volaille.jpg",
    tags: ['gluten-free'],
    allergens: ['lait'],
    isSignature: false,
    isAvailable: true,
  ...
  {
    id: 'lp3',
    name: "Risotto aux Asperges Vertes",
    description: "Parmesan, œuf poché, copeaux de truffe d'été",
    price: 32,
    category: 'main',
    menuType: 'lunch',
    image: "/images/plats/risotto-asperges.jpg",
    tags: ['vegetarian', 'gluten-free'],
  ...
  // Menu Déjeuner - Desserts
  {
    id: 'ld1',
    name: "Tarte au Citron Meringuée",
    description: "Meringue italienne flambée, sorbet citron vert",
    price: 14,
    category: 'dessert',
    menuType: 'lunch',
    image: "/images/plats/tarte-citron.jpg",
    tags: ['vegetarian'],
    allergens: ['gluten', 'oeufs', 'lait'],
    isSignature: false,
    isAvailable: true,
  ...
  },
  {
    id: 'ld2',
    name: "Café Gourmand",
    description: "Expresso accompagné de 4 mignardises du Chef pâtissier",
    price: 12,
    category: 'dessert',
    menuType: 'lunch',
    image: "/images/plats/cafe-gourmand.jpg",
    tags: ['vegetarian'],
    allergens: ['gluten', 'lait', 'oeufs', 'fruits à coque'],
    isSignature: false,
    isAvailable: true,
    order: 2,
  },
  ...
  {
    id: 'te1',
    name: "Amuse-bouche du Chef",
    description: "Trilogie de saveurs : huître, foie gras, légume du moment",
    price: 0,
    category: 'starter',
    menuType: 'tasting',
    image: "/images/plats/amuse-bouche.jpg",
    tags: [],
  ...
  {
    id: 'te2',
    name: "Saint-Jacques en Carpaccio",
    description: "Truffe noire, noisettes torréfiées, vinaigrette aux agrumes",
    price: 0,
    category: 'starter',
    menuType: 'tasting',
    image: "/images/plats/saint-jacques.jpg",
    tags: ['gluten-free'],
    allergens: ['mollusques', 'fruits à coque'],
    isSignature: true,
    isAvailable: true,
    order: 2,
  },
  {
    id: 'tp1',
    name: "Langoustines Royales",
    description: "Snackées, bisque légère, légumes croquants de saison",
    price: 0,
    category: 'main',
    menuType: 'tasting',
    image: "/images/plats/langoustines.jpg",
    tags: ['gluten-free'],
    allergens: ['crustacés'],
    isSignature: true,
    isAvailable: true,
  ...
  },
  {
    ...
    description: "Sauce aux morilles, pommes grenaille confites",
    price: 0,
    category: 'main',
    menuType: 'tasting',
    image: "/images/plats/ris-veau.jpg",
    tags: ['gluten-free'],
    allergens: ['lait'],
    isSignature: true,
    isAvailable: true,
  ...
  },
  {
    ...
    description: "3 fromages sélectionnés, pain aux fruits secs, confiture maison",
    price: 0,
    category: 'cheese',
    menuType: 'tasting',
    image: "/images/plats/fromages.jpg",
  ...
  {
    id: 'td1',
    name: "Pré-dessert Surprise",
    description: "Création légère et rafraîchissante du Chef pâtissier",
    price: 0,
    category: 'dessert',
    menuType: 'tasting',
    image: "/images/plats/pre-dessert.jpg",
    tags: ['vegetarian', 'gluten-free'],
    allergens: ['lait'],
    isSignature: false,
    isAvailable: true,
  ...
  {
    id: 'td2',
    name: "Grand Dessert Signature",
    description: "Chocolat grand cru, praliné feuilleté, glace vanille Bourbon",
    price: 0,
    category: 'dessert',
    menuType: 'tasting',
    image: "/images/plats/dessert-signature.jpg",
    tags: ['vegetarian'],
    allergens: ['gluten', 'lait', 'oeufs', 'fruits à coque'],
    isSignature: true,
    isAvailable: true,
